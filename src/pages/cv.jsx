                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <span>
                        O2 Web, Montreal (June 2021 – present, 1 year)
                      </span>
                      <ul className="list-disc">
                        ...
                        <li>
                          Excelled in cross-functional 5+ teams while applying
                          and improving our methodologies and practices (
                          <i>
                            Agile scrum, Git, code reviews, documentation,
                            project management
                          </i>
                          )
                        </li>
                  ...
                  <tr>
                    <td>
                      ...
                      <ul className="list-disc">
                        <li>
                          Deliver WordPress sites and custom functionalities
                          based on mock-ups and analysis of clients' needs with
                          a close focus on responsive, SEO and user experience
                        </li>
                      </ul>
                    </td>
                  </tr>
